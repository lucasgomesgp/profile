              ...
              <HabilitiesSection>
                <Section>
                  <Circle>
                    ...
                    >
                      <path
                        d="M50 59.375V96.875"
                        stroke="url(#paint0_linear_32_76)"
                        strokeWidth="5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M50 59.375C54.3147 59.375 57.8125 55.8772 57.8125 51.5625C57.8125 47.2478 54.3147 43.75 50 43.75C45.6853 43.75 42.1875 47.2478 42.1875 51.5625C42.1875 55.8772 45.6853 59.375 50 59.375Z"
                        stroke="url(#paint1_linear_32_76)"
                        strokeWidth="5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M28.125 28.125V12.5C28.125 11.6712 28.4542 10.8763 29.0403 10.2903C29.6263 9.70424 30.4212 9.375 31.25 9.375H68.75C69.5788 9.375 70.3737 9.70424 70.9597 10.2903C71.5458 10.8763 71.875 11.6712 71.875 12.5V28.125"
                        stroke="url(#paint2_linear_32_76)"
                        strokeWidth="5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M28.1343 28.125L17.4312 49.7656C17.183 50.2812 17.0775 50.8538 17.1256 51.424C17.1737 51.9942 17.3736 52.5411 17.7046 53.0078L50.0093 96.875L82.314 53.0078C82.645 52.5411 82.845 51.9942 82.893 51.424C82.9411 50.8538 82.8356 50.2812 82.5874 49.7656L71.8843 28.125H28.1343Z"
                        stroke="url(#paint3_linear_32_76)"
                        strokeWidth="5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                ...
                <Section>
                  <Circle>
                    ...
                    >
                      <path
                        d="M25 34.375L6.25 50L25 65.625"
                        stroke="url(#paint0_linear_32_85)"
                        strokeWidth="5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M75 34.375L93.75 50L75 65.625"
                        stroke="url(#paint1_linear_32_85)"
                        strokeWidth="5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M62.5 15.625L37.5 84.375"
                        stroke="url(#paint2_linear_32_85)"
                        strokeWidth="5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                ...
                <Section>
                  <Circle>
                    ...
                    >
                      <path
                        d="M68.75 9.375H31.25C27.7982 9.375 25 12.1732 25 15.625V84.375C25 87.8268 27.7982 90.625 31.25 90.625H68.75C72.2018 90.625 75 87.8268 75 84.375V15.625C75 12.1732 72.2018 9.375 68.75 9.375Z"
                        stroke="url(#paint0_linear_32_93)"
                        strokeWidth="5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M25 21.875H75"
                        stroke="url(#paint1_linear_32_93)"
                        strokeWidth="5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M25 78.125H75"
                        stroke="url(#paint2_linear_32_93)"
                        strokeWidth="5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
